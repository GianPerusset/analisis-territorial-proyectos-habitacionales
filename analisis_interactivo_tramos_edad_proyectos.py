...
# =========================================================
# VARIABLES TRAMOS ETARIOS
# =========================================================
# Denominador: n_per = población total

VARIABLES_EDAD = {
    "n_edad_60_mas": "60 o más",
    "n_edad_45_59": "45 a 59",
    "n_edad_25_44": "25 a 44",
    "n_edad_18_24": "18 a 24",
    "n_edad_14_17": "14 a 17",
    "n_edad_6_13": "6 a 13",
    "n_edad_0_5": "0 a 5"
}

VARIABLES_NECESARIAS = list(VARIABLES_EDAD.keys()) + ["n_per"]
...
print("=" * 90)
print("ANÁLISIS INTERACTIVO TRAMOS ETARIOS - PROYECTOS")
print("=" * 90)
...
orden_variables = list(VARIABLES_EDAD.keys())
orden_labels = list(VARIABLES_EDAD.values())
...
ruta_excel = SALIDAS_DIR / "26_resumen_tramos_edad_proyectos.xlsx"

with pd.ExcelWriter(ruta_excel, engine="openpyxl") as writer:
    df_detalle.to_excel(writer, sheet_name="Detalle_proyectos", index=False)
    df_excel.to_excel(writer, sheet_name="Datos_tramos_edad", index=False)
    df_brechas_excel.to_excel(writer, sheet_name="Brechas_tramos_edad", index=False)
...
ruta_html = SALIDAS_DIR / "27_interactivo_tramos_edad_proyectos.html"
...
<head>
    <meta charset="UTF-8">
    <title>Distribución de la población por tramo etario</title>
...
<body>
    <div class="container">
        <main class="main">
            <div class="header">
                <h1>Distribución de la población por tramo etario</h1>
                <p id="subtitle"></p>
            </div>
        ...
        <aside class="sidebar">
            <div class="sidebar-card">
                ...
                <div class="control-block">
                    ...
                    <div class="tab-buttons">
                        <button class="tab-button active" id="btnConteos">
                            Página 1 — Personas por tramo etario
                        </button>
                ...
                <div class="note">
                    Los tramos etarios son grupos excluyentes. La página porcentual muestra la distribución de cada tramo sobre la población total del nivel territorial.
                </div>
            </div>
        </aside>
    </div>
    ...
    <script>
        ...
        function buildLayout() {{
            ...
            if (isConteos) {{
                pageTitleText = "Página 1: Personas por tramo etario";
                pageSubtitleText = "Comparación de magnitudes absolutas entre Región Metropolitana, comuna y manzana.";
            }}

            if (isPorcentajes) {{
                pageTitleText = "Página 2: Distribución porcentual de la población por tramo etario";
                pageSubtitleText = "Comparación proporcional sobre la población total de cada nivel territorial.";
            }}

            if (isBrechas) {{
                pageTitleText = "Página 3: Matriz de color de brechas por tramo etario";
